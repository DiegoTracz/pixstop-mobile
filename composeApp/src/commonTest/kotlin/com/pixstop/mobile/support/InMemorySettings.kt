 ...
 *
 * Escrito à mão em vez de trazer o `multiplatform-settings-test`: a interface
 * é pequena, e uma dependência a mais no projeto por causa de teste é decisão
 * que não cabe a um arquivo de teste tomar.
 */
